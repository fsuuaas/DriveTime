<form id="carEditForm" class="" action="{{route('admin.rentals.update', $rental)}}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-12 {{ $errors->has('name') ? ' has-error' : '' }}">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Car Name" name="name" value="{{$rental->user->name}}">
                                </div>
                                @if ($errors->has('name'))
                            ...
                            <div class="col-sm-6 col-12 {{ $errors->has('phone') ? ' has-error' : '' }}">
                                <div class="mb-3">
                                    <label class="form-label">Customer Phone <span class="text-red">*</span></label>
                                    <input type="text" class="form-control" placeholder="Enter Car Brand" name="phone" value="{{$rental->user->phone}}">
                                </div>
                                @if ($errors->has('phone'))
                                    <span class="help-block">
                            ...
                            <div class="col-sm-12 col-12 {{ $errors->has('address') ? ' has-error' : '' }}">
                                <div class="mb-3">
                                    <label class="form-label">Customer Address <span class="text-red">*</span></label>
                                    <textarea class="form-control" name="address" rows="3">{{$rental->user->address}}</textarea>
                                </div>
