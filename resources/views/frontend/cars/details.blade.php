...
@section('main')
<!-- Breakcrumb -->
<div class="widget-breakcrumb" style="padding-top: 180px;">
                ...
                <div class="wrap-property-car flex">
                    <div class="box-1">
                        <div class="icon-box-info flex">
                            ...
                            <div class="info flex">
                                <span>Make:</span>
                                <span class="fw-4">Toyota</span>
                            </div>
                            <div class="info flex">
                                <span>Model:</span>
                                <span class="fw-4">XC60</span>
                            </div>
                            <div class="info flex">
                                <span>Body:</span>
                                <span class="fw-4">Sedan</span>
                            </div>
                        </div>
                        <div class="title-heading">Chevrolet Suburban 2021</div>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <div class="post-property">
                        ...
                        <div class="listing-address">
                            <svg width="22" height="30" viewBox="0 0 22 30" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="#D01818" stroke-width="2" stroke-miterlimit="10"
                    ...
                    <div class="wrap-car-calculator wrap-style">
                        ...
                        <form action="/" id="calculator">
                            ...
                            <div class="btn-wrap-form mt-45">
                                <div class="btn-main">
                                    <button class="button_main_inner" type="submit">
                                        Calculate Payment
                                    </button>
                                </div>
                                <a href="#" class="btn-reset">
                                    <i class="icon-rotate-left-circular-arrow-interface-symbol-1"></i>
                                    Reset All
                                </a>
                            </div>
                        </form>
                    ...
                    <div class="wrap-car-leave-a-reply">
                        <h4 class="title">Customer Review</h4>
                        <form action="/" id="leave-a-reply">
                            <div class="rating-wrap">
                                <div class="rating-box">
                                    <label> Comfort </label>
                                    <div id="rating_comfort_service" class="star-rating-review">
                                        <i class="icon-Vector3"></i>
                                        <i class="icon-Vector3"></i>
                                        <i class="icon-Vector3"></i>
                                        <i class="icon-Vector3"></i>
                                ...
                                <div class="rating-box">
                                    ...
                                    <div id="rating_performance" class="star-rating-review">
                                        <i class="icon-Vector3"></i>
                                        <i class="icon-Vector3"></i>
                                        <i class="icon-Vector3"></i>
                                        <i class="icon-Vector3"></i>
                                ...
                                <div class="rating-box">
                                    ...
                                    <div id="rating_interior_design" class="star-rating-review">
                                        <i class="icon-Vector3"></i>
                                        <i class="icon-Vector3"></i>
                                        <i class="icon-Vector3"></i>
                                        <i class="icon-Vector3"></i>
                                ...
                                <div class="rating-box">
                                    <label> Speed </label>
                                    <div id="rating_speed" class="star-rating-review">
                                        <i class="icon-Vector3"></i>
                                        <i class="icon-Vector3"></i>
                                        <i class="icon-Vector3"></i>
                                        <i class="icon-Vector3"></i>
                            ...
                            <div class="post-comment">
                                <div class="d-flex">
                                    <fieldset class="input-post-comment">
                                ...
                                <fieldset class="input-post-comment">
                                    <textarea class="write-post-comment">Write Review</textarea>
                                    <i class="icon-edit-1"></i>
                                </fieldset>
                                <fieldset class="input-post-comment">
                                    <div class="radio">
                                        <input id="check-comment" type="checkbox" name="check"
                                               value="check">
                                        <label for="check-comment">I agree to Terms & Conditions, Refund
                ...
                <div class="author-contact-listing-wrap">
                    <div class="author-contact-wrap">
                        ...
                        <div class="author-contact-info">
                            ...
                            <p class="desc">Owner of listing</p>
        ...
        <div class="related-single-listing swiper">
            <div class="swiper-wrapper">
                                ...
                                <div class="listing-item view-gallery" title="Lexus LC Hybrid 2024">
                                    <div class="images">
                                        ...
                                        <div class="overlay-limit">
                                            <img src="./assets/images/car-list/img.png" class="icon-img"
                                                 alt="icon-map">
                                            <p>2 more photos</p>
                                        </div>
                                    </div>
                ...
                <div class="listing-grid-item swiper-slide">
                    ...
                    <div class="listing-item-content">
                        <div class="listing-top-content">
                            <h6 class="title"><a href="listing-details.html">Mercedez benz - c class</a></h6>
                            <div class="review-wrap">
                                <div class="rating">
                                    <i class="icon-Vector3"></i>
                                    <i class="icon-Vector3"></i>
