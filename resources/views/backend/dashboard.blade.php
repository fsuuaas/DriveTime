                    ...
                    <div class="table-responsive">
                        <table class="table v-middle">
                            ...
                            <tr>
                                <td>
                                    <div class="media-box">
                                        <img src="{{asset('backend/images/user3.png')}}" class="media-avatar" alt="Bootstrap Gallery">
                                ...
                                <td>
                                    <div class="media-box">
                                        <img src="{{asset('backend/images/food/img3.jpg')}}" class="media-avatar" alt="Admin Themes">
                                        <div class="media-box-body">
                            ...
                            <tr>
                                <td>
                                    <div class="media-box">
                                        <img src="{{asset('backend/images/user.png')}}" class="media-avatar" alt="Bootstrap Gallery">
                                        <div class="media-box-body">
                                ...
                                <td>
                                    <div class="media-box">
                                        <img src="{{asset('backend/images/food/img6.jpg')}}" class="media-avatar" alt="Admin Themes">
                                        <div class="media-box-body">
                            ...
                            <tr>
                                <td>
                                    <div class="media-box">
                                        <img src="{{asset('backend/images/user4.png')}}" class="media-avatar" alt="Bootstrap Gallery">
                                        <div class="media-box-body">
                                ...
                                <td>
                                    <div class="media-box">
                                        <img src="{{asset('backend/images/food/img5.jpg')}}" class="media-avatar" alt="Admin Themes">
                                        <div class="media-box-body">
                        ...
                        <div class="activity-container">
                            <div class="activity-block">
                                <div class="activity-user">
                                    <img src="{{asset('backend/images/user.png')}}" alt="Activity User">
                                </div>
                            ...
                            <div class="activity-block">
                                <div class="activity-user">
                                    <img src="{{asset('backend/images/user3.png')}}" alt="Activity User">
                                </div>
                                <div class="activity-details">
                            ...
                            <div class="activity-block">
                                <div class="activity-user">
                                    <img src="{{asset('backend/images/user4.png')}}" alt="Activity User">
                                </div>
                                <div class="activity-details">
                            ...
                            <div class="activity-block">
                                <div class="activity-user">
                                    <img src="{{asset('backend/images/user5.png')}}" alt="Activity User">
                                </div>
                                <div class="activity-details">
                            ...
                            <div class="activity-block">
                                <div class="activity-user">
                                    <img src="{{asset('backend/images/user2.png')}}" alt="Activity User">
                                </div>
                                <div class="activity-details">
                                    <h4>Ilyana Maes</h4>
                                    <h5>One week ago</h5>
...
@section('page-script')
    ...
    <script src="{{asset('backend/vendor/apex/custom/sales/salesGraph.js')}}"></script>
    <script src="{{asset('backend/vendor/apex/custom/sales/revenueGraph.js')}}"></script>
    <script src="{{asset('backend/vendor/apex/custom/sales/taskGraph.js')}}"></script>
@stop
